...
class Rectangle:
    ...
    def __str__(self):
        ...
        if self.width == 0 or self.height == 0:
            return ""
        symbol = str(self.print_symbol)  # Assure la conversion en chaîne
...
# puis assemble toutes les lignes en les séparant par des retours à la ligne
    ...
    def __repr__(self):
        ...
        permettant de recréer l'objet avec eval().
        """
        return f"Rectangle({self.__width}, {self.__height})"

    def __del__(self):
        """Affiche un message quand un objet Rectangle est supprimé."""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
    ...
    def square(cls, size=0):
        """
        Retourne un nouveau rectangle dont la largeur et la hauteur
        sont égales à size.
        """
